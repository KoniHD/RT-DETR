...
def parse_args():
    ...
    parser.add_argument('--custom-train-val', type=two_lists, default="2,3,5/1,4/", help='Two lists seperated by / to set custom train/val/test split based on LOCO subsets.')
